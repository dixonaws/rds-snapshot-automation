...
# do you need the subnet-ids parameter?
# aws ec2 run-instances --image-id ami-b70554c8 --count 1 --instance-type t2.micro --key-name dixonaws --security-group-ids ami-b70554c8 --subnet-id subnet-6e7f829e